...
import com.yoga.movieapp.ui.theme.Teal200
import com.yoga.movieapp.ui.theme.cornerRadius
import com.yoga.movieapp.utils.conditional
import com.yoga.movieapp.utils.items
...
fun SelectableGenreChip(
    ...
    val animateChipBackgroundColor by animateColorAsState(
        targetValue = if (selected) Teal200 else SecondaryFontColor,
        animationSpec = tween(
            durationMillis = 50,
            delayMillis = 0,
